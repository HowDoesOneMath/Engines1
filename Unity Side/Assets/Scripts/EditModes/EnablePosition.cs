...
public class EnablePosition : EdittingMode
{
    Thingy editee;
    MeshCollider MC;
    MeshFilter[] mf;
    ...
    public void SetEnablePosition(DirtyFlagController controller, EdittingMode prev, List<GameObject> setToActive, Thingy toBeEditted, MeshFilter[] thingyMeshes)
    {
        SetEdittingMode(controller, prev, setToActive);
        editee = toBeEditted;
        mf = thingyMeshes;

        backButton = dcf.modes.sPos.backButton;
    }
